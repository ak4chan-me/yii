...
?>
	...
	<div class="col-8">		
		<form 
			action="<?=Yii::app()->createUrl('proses/unggah',array('id'=>$model->traId));?>"
			method="post" enctype="multipart/form-data">
			<input type="file" name="bukti">
			<br>
			<br>
			<input type="submit" class="btn btn-primary" value="Unggah Bukti Bayar">
		</form>
		<hr>
		<?php 
...
<?php echo CHtml::link('Kembali',array('transaksi'),array('class'=>'btn btn-primary')); ?>